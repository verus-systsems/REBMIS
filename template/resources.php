                ...
                <div class="widget ">
                    ...
                    <div class="widget-content">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                <td>1</td>
                                <td>John banked 4178200 frw after selling his car. Write the amount of that money in words</td>
                                <td>Reading, writing, comparing and calculating whole numbers up to 1,000,000</td>
                                <td>Mathematics</td>
                                <td>P5</td>
                                <td><a href="javascript:;" class="btn btn-small btn-success"><i class="btn-icon-only icon-tasks"> </i></a></td>
                            </tr>

                            <tr>
                                <td>2</td>
                                <td>There are two hundred thousand six hundred eight one English books for reading. what is that number of the books in figures?</td>
                                <td>Reading, writing, comparing and calculating whole numbers up to 1,000,000</td>
                                <td>Mathematics</td>
                                <td>P5</td>
                                <td><a href="javascript:;" class="btn btn-small btn-success"><i class="btn-icon-only icon-tasks"> </i></a></td>
                            ...
                            <tr>
                                <td>3</td>
                                <td>What is the place value of 0 and 9 in the numbers bolow:
                                    a.70595624
                                    b. 2016829
                                </td>
                                <td>Reading, writing, comparing and calculating whole numbers up to 1,000,000</td>
