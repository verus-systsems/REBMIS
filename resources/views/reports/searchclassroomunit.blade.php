    ...
    <div class="row">
        ...
        <div class="span12">
            ...
            <div id="target-1" class="widget">
                ...
                <div class="widget-content">
                    <p><strong>District:</strong> {{$thedistrict->district_name}} <strong>Sector:</strong> {{$thesector->sector_name}} <strong>School:</strong> {{$theschool->school_name}}
                    </p>

                    <p><strong>Grade:</strong> {{$thegrade->grade_name}} <strong>Subject:</strong> {{$thesubject->subject_title}}  <strong>Unit:</strong> {{$theunit->unit_name}}
